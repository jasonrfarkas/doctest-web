...
In your terminal, type or copy-paste the following:
    ...
    git clone git@github.com:Fueled/doctest-web.git; cd doctest-web; fab init
...
[contributing]: http://github.com/Fueled/doctest-web/tree/master/CONTRIBUTING.md
