# -*- coding: utf-8 -*-
"""Django settings for docTest project.
...
APPS_DIR = ROOT_DIR.path('doctest')
...
ADMINS = getaddresses([env("DJANGO_ADMINS", default='docTest Admin <admin@example.com>')])
...
# ------------------------------------------------------------------------------
REST_FRAMEWORK = {
    'DEFAULT_PAGINATION_CLASS': 'doctest.base.api.pagination.PageNumberPagination',
    'PAGE_SIZE': 30,
    ...
    "EXCEPTION_HANDLER": "doctest.base.exceptions.exception_handler",
}
# DJANGO_SITES
# ------------------------------------------------------------------------------
...
DATABASES = {
    'default': env.db("DATABASE_URL", default="postgres://localhost/doctest"),
}
